...
// FIX: Using the verified admin check we created earlier
...
export default async function AdminDashboard() {
  ...
  // SEC-1: If not an admin, boot them to the homepage or login
  if (!isAdmin) {
    redirect('/');
  }
  ...
  // 2. Fetch Products & Stats in parallel for speed
