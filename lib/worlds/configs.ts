...
export const homeWorldConfig: WorldConfig = {
  ...
  hero: {
    ...
    description:
      "A curated sector for the architecture of daily life. From domestic inventory to family legacy planning—tools built for permanence.",
  },
  grid: {
    icon: ICONS.sparkles,
...
export const lifestyleWorldConfig: WorldConfig = {
  ...
  hero: {
    ...
    titleClasses: "italic",
    description:
      "A sector dedicated to the rituals of focus and well-being. Tools for those who treat their digital habits as an art form.",
  },
  grid: {
    icon: Coffee,
  ...
  footer: {
    ...
    titleClasses: "italic",
    quote:
      "In the Lifestyle World, we prioritize digital objects that offer mental clarity and aesthetic joy. No clutter. No subscriptions. Just permanent, beautiful utility.",
  },
};
...
export const toolsWorldConfig: WorldConfig = {
  ...
  hero: {
    ...
    description:
      "A technical sector for high-leverage components. Engineered for professionals who require architectural stability in their digital stack.",
  },
  grid: {
    icon: Hammer,
