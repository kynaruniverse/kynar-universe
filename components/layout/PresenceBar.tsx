        ...
        >
          ...
          {isUserActive && (
            <span className="absolute right-2.5 top-2.5 flex h-1.5 w-1.5">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-kyn-green-400 opacity-75" />
              <span className="relative inline-flex h-1.5 w-1.5 rounded-full bg-kyn-green-500" />
            </span>
          )}
        </button>
      </div>
