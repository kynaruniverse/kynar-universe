...
import { Database } from "@/lib/supabase/types"; // Correct type source
...
export const PresenceBar = ({ 
  ...
  return (
    <header className="sticky top-0 z-50 flex h-14 w-full items-center justify-between border-b border-kyn-slate-100 bg-canvas/95 px-4 backdrop-blur-sm md:h-16 md:px-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="h-3 w-[1px] bg-kyn-slate-200" />
        ...
        <div className="flex items-center">
          {profile ? (
            ...
            >
              ...
              <div className="h-8 w-8 rounded-full bg-surface border border-kyn-slate-200 flex items-center justify-center text-text-secondary group-hover:border-text-primary transition-colors duration-300">
