...
export default function HelpPage() {
  ...
  return (
    <div className="min-h-screen bg-kyn-canvas dark:bg-kyn-slate-950 px-6 py-12 pb-40">
      ...
      <main className="max-w-2xl mx-auto">
        ...
        <div className="relative mb-12 group">
          <Search className="absolute left-5 top-1/2 -translate-y-1/2 text-kyn-slate-300 group-focus-within:text-kyn-green-500 transition-colors" size={20} />
          <input 
            type="text" 
            placeholder="Search the archive..."
            className="w-full bg-white dark:bg-kyn-slate-900 p-6 pl-14 rounded-[2rem] border border-kyn-slate-100 dark:border-kyn-slate-800 outline-none focus:ring-4 focus:ring-kyn-green-500/5 shadow-kyn-lift transition-all font-medium text-sm"
            value={searchQuery}
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          <div className="kyn-card p-8 bg-kyn-green-50/50 dark:bg-kyn-green-900/10 border-kyn-green-100 dark:border-kyn-green-900/20">
            ...
            <h3 className="text-[10px] font-black uppercase tracking-[0.2em] mb-2">User Guides</h3>
            ...
            <button className="text-[10px] font-black uppercase tracking-widest text-kyn-green-600 flex items-center gap-2">
              Explore Docs <ChevronRight size={14} />
            </button>
          </div>

          <div className="kyn-card p-8 bg-kyn-slate-900 text-white border-none shadow-2xl">
            <div className="w-10 h-10 bg-kyn-slate-800 rounded-xl flex items-center justify-center mb-6">
              <MessageSquare className="text-kyn-green-400" size={20} />
            </div>
            <h3 className="text-[10px] font-black uppercase tracking-[0.2em] mb-2 text-kyn-slate-400">Human Support</h3>
            <p className="text-xs text-kyn-slate-300 font-medium italic mb-4">Direct access to our UK-based team.</p>
            <button className="text-[10px] font-black uppercase tracking-widest text-kyn-green-400 flex items-center gap-2">
        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-3">
            {filteredFaqs.map((faq, index) => (
              <details key={index} className="group kyn-card bg-white dark:bg-kyn-slate-900/50 border-kyn-slate-50 dark:border-kyn-slate-800 overflow-hidden">
                ...
                <div className="px-6 pb-6 text-sm text-kyn-slate-500 dark:text-kyn-slate-400 leading-relaxed font-medium italic border-t border-kyn-slate-50 dark:border-kyn-slate-800 pt-6">
                  "{faq.a}"
                </div>
              </details>
            ))}
        ...
        {/* Status Footer */}
        <footer className="mt-20 p-8 rounded-[2.5rem] bg-white dark:bg-kyn-slate-900 border border-kyn-slate-100 dark:border-kyn-slate-800 text-center">
          ...
          <p className="text-[10px] font-bold text-kyn-slate-400 mb-6">
            Account: <span className="text-kyn-slate-900 dark:text-white uppercase">{user?.email || 'Guest Explorer'}</span>
          </p>
          <button className="inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-kyn-slate-100 dark:border-kyn-slate-800 text-[10px] font-black uppercase tracking-widest text-kyn-slate-600 dark:text-kyn-slate-300 hover:bg-kyn-slate-50 transition-colors">
            <Globe size={14} />
