        ...
        >
          ...
          <div className="mb-12 flex items-start gap-4 p-6 bg-brand-surface/10 rounded-inner border border-brand-surface/20">
            ...
            <p className="text-xs font-medium text-brand-text/60 leading-relaxed">
              <strong>Shop Preview Notice:</strong> No products are currently for sale. This site and all listed items are in preview mode. Checkout systems are currently inactive.
            </p>
          </div>
          ...
          <div className="space-y-20">
            ...
            <section className="space-y-6">
              ...
              <p className="text-lg font-medium text-brand-text/60 leading-relaxed max-w-2xl">
                Kynar is a digital storefront based in the United Kingdom. We provide high-quality digital assets designed for professional and creative use. During this preview phase, items are displayed for demonstration and testing purposes only.
              </p>
            </section>
            ...
            <section className="space-y-8 p-10 md:p-16 bg-brand-text rounded-[40px] shadow-tactile text-white/70">
              ...
              <p className="font-medium text-xl leading-relaxed">
                Under the <span className="text-white font-semibold">Consumer Contracts Regulations 2013</span>, digital products are exempt from the 14-day cancellation right once the download begins. By completing a future purchase, you waive this right in exchange for immediate access. <em>Note: All purchasing functions are currently disabled.</em>
              </p>
              <div className="mt-10 flex items-center gap-3 text-[10px] font-bold text-brand-accent uppercase tracking-[0.2em]">
                <Zap size={14} /> UK Statutory laws apply to product integrity.
              </div>
            </section>
            ...
            <section className="space-y-6">
              ...
              <p className="text-lg font-medium text-brand-text/60 leading-relaxed max-w-2xl">
                An account grants a non-exclusive, personal license for previewing our products. Redistribution, replication, or commercial resale of our intellectual property is strictly prohibited to maintain the quality of the platform.
              </p>
            </section>
            ...
            <section className="space-y-6">
              ...
              <p className="text-lg font-medium text-brand-text/60 leading-relaxed max-w-2xl">
                Products are provided &ldquo;as is.&rdquo; To the maximum extent permitted by the laws of England and Wales, Kynar is not liable for incidental disruptions following the use of our digital products.
              </p>
            </section>
