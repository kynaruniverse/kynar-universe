 ...
 * Role: Primary entry point & world-selection portal.
 * Optimization: Mobile-first grid & Next.js 16 Server-First rendering.
 */
...
export default function UniverseGate() {
  ...
  return (
    <main className="relative flex min-h-[90vh] flex-col items-center justify-center px-gutter py-12 md:py-24 overflow-hidden">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {worlds.map((world) => (
            ...
            >
              ...
              <h3 className="font-brand text-2xl font-bold text-kyn-slate-900">{world.name}</h3>

              <p className="mt-3 font-ui text-sm leading-relaxed text-text-secondary">{world.desc}</p>
      ...
      {/* Secondary Discovery / Marketplace Link */}
