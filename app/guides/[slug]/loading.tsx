    ...
    <article className="min-h-screen bg-canvas pb-32 animate-in fade-in duration-500 ease-out">
      <div className="max-w-screen-md mx-auto px-6">
        ...
        <header className="py-12 md:py-20">
          {/* Metadata Chips: Aligned with v1.6 Typography */}
          ...
          {/* Headline Skeleton: Prevents text reflow on hydration */}
          ...
          {/* Intelligence Bar: Matches GuidePage v1.6 vertical spacing */}
        ...
        <div className="space-y-10 pt-6">
          ...
          {/* Media Vessel Placeholder: Aspect ratio locked for mobile reliability */}
          <div className={cn(
