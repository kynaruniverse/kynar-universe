 ...
 * Aligned with Brand Language 3.1: Focusing on "Intentional Art and Systems."
 */
export default async function GuidesPage() {
  // Fetch only published guides for public consumption
  ...
  return (
    <div className="min-h-screen bg-kyn-canvas dark:bg-kyn-slate-900 pb-40 pt-24 md:pt-32">
      {/* Header Section */}
      <header className="px-6 pb-8 max-w-4xl mx-auto">
      ...
      <main className="px-6 max-w-4xl mx-auto space-y-16">
        ...
        {/* Featured Spotlight (UX Guide 2.4) */}
        {featuredGuide && (
        ...
        <div className="flex items-center justify-between border-b border-kyn-slate-100 dark:border-kyn-slate-800 pb-4">
          ...
          <button className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-kyn-slate-900 dark:text-white hover:text-kyn-green-600 transition-colors">
            <Filter size={14} />
            Filter
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {remainingGuides.length > 0 ? (
            ...
            <div className="py-20 text-center col-span-full border-2 border-dashed border-kyn-slate-100 dark:border-kyn-slate-800 rounded-kyn">
