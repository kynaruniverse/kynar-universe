/**
 * KYNAR UNIVERSE: Briefings Archive (v1.7)
 * Role: Central repository for all world intelligence
 * Refactor: Improved readability, type safety, and animation consistency
 */
...
export const metadata: Metadata = {
  ...
  description:
    "Explore the technical and narrative architecture of the Kynar Universe.",
};
        ...
        {guides.length > 0 ? (
          <div className="grid grid-cols-1 gap-y-10 md:grid-cols-2 md:gap-x-12 lg:grid-cols-3">
            {guides.map((guide, index) => {
              const readTime = guide.read_time_minutes ?? 5;
